...
outputframe = np.ndarray(shape=(480*2, 640*2, 3))
...
while ret:
    ...
    outputframe[480*0:480*1, 640*0:640*1, :] = normalizedframe
    outputframe[480*0:480*1, 640*1:640*2, :] = red
    outputframe[480*1:480*2, 640*0:640*1, :] = green
    outputframe[480*1:480*2, 640*1:640*2, :] = blue
